...
extern void game_mouseButton(int x, int y, int button);
...
namespace Advanced2D 
{
	...
	private:
		...
		LPDIRECT3DSURFACE9 ppMainSurface;
		LPDIRECT3DSURFACE9 ppMainDepthStencilSurface;
